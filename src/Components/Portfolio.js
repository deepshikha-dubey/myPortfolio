...
import aicirts from '../assets/AI_certs.jpg'
...
<div className='portfolioImage justify-center'>
   <img src={ aicirts } className='w-[400px]'/> 
   <p> <a href='https://deepshikha-dubey.github.io/ai_cirts/' target='_blank'>AI CIRTs project demo</a></p>
</div>
   
<div className='portfolioImage justify-center'>
   <img src={ wordpress } className='w-[400px]'/> 
   <p><a href='https://deepshikhadubeycom.wordpress.com/'> Technology consulting company</a> </p>
</div>

<div className=' portfolioImage'>
            <img src={weather} className='w-[400px]'/> 
            <p><a href='https://stackoverflowmern-areu.onrender.com/CheckWeather/' target='_blank'>Weather App</a></p>
    </div> 
    <div className=' portfolioImage'>
...
<div className='portfolioImage justify-center'>
  ...
  <div className=' portfolioImage'>
   ...
   <div className=' portfolioImage'>
        <a href='my_krishna.jpg' target='_blank'>
    ...
    <div className=' portfolioImage'>
            ...
            <p><a href="https://deepshikha-dubey.github.io/hangmangame/" target= "_blank">Hangman Game</a></p>
    </div> 
